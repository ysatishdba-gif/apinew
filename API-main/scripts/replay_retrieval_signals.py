...
``temporal_by_candidate`` (v3), ``record_types``, timing and usage metadata.
    ...
    row.update(
        {
            ...
            "temporal_by_candidate": q.get("temporal_by_candidate"),
            ...
            "temporal_mode": (body.get("details") or {}).get("temporal_mode"),
