...
class TestDocumentCluster:
    ...
    def test_resolve_record_type_cuis_default_path_batches_bigquery(
        ...
        # member documents the service named, then the record-type names
        # themselves (looked up directly for abbreviations / variants)
...
class TestEndpointV2:
    ...
    def test_200_ungated_same_envelope_as_v1_with_cluster_record_types(self, client):
        ...
        # /v1 prompt, KNOWN RECORD TYPES block included: record-type names are
        # generated exactly as /v1; only their coding comes from the cluster.
