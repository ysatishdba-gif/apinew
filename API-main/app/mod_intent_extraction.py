...
class ContextualIntentPipeline:
    ...
    def _canonical_temporal_slots(
        ...
        menu (from the index), query shortlist (index similarity), learned
        examples (cadence memory) and the vocabulary's default name. Every part
        is derived from data and bounded by settings; the vocabulary list itself
        is never injected."""
